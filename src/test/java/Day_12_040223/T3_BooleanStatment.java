...
public class T3_BooleanStatment extends Reusable_Annotation {

    @Test(priority = 1)
    public void verifyCheckBoxIsChecked(){
        driver.navigate().to("https://www.yahoo.com");
        //click on Sign In
        Reusable_Method.clickMethod(driver,"//*[@class='_yb_1dbys']","Sign In");
    ...
    public void verifyCheckBoxISnotChecked() throws InterruptedException {
        ...
        Thread.sleep(2000);
        Reusable_Method.verifyBooleanStatement(driver,"//*[@id='persistent']",false,"Checkbox");
    }//end of test 2
